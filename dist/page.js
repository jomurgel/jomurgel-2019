...
/* harmony import */ var _util_logo__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./util/logo */ "./src/js/util/logo.js");
...
if (Object(_util_helpers__WEBPACK_IMPORTED_MODULE_3__["hasClass"])(body, 'home blog')) {
  Object(_util_logo__WEBPACK_IMPORTED_MODULE_2__["initHomeLogo"])();
} else {
  Object(_util_logo__WEBPACK_IMPORTED_MODULE_2__["initLogo"])();
}
...
/**
 * This is the partial for our pages.
 */
...
/*!*****************************!*\
  !*** ./src/js/util/logo.js ***!
  \*****************************/
/*! exports provided: initHomeLogo, initLogo */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initHomeLogo", function() { return initHomeLogo; });
 ...
 */
var initHomeLogo = function initHomeLogo() {
  // Let's trigger that awesome logoness.
  document.addEventListener('DOMContentLoaded', function () {
    var line = document.querySelector('.sig-line');
    var dot = document.querySelector('.sig-dot');
    setTimeout(function () {
...
var initMenu = function initMenu() {
  ...
  var menu = document.getElementById('primary'); // Return if no menu exists.
  ...
  if (Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["hasClass"])(body, 'nav-is-visible')) {
  ...
  window.addEventListener('resize', function (event) {
    var windowWidth = window.innerWidth; // If we have an open nav, and we're above the mobile breakpoint.
    // Open nav.

    if (Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["hasClass"])(body, 'nav-is-visible') && 1024 < windowWidth) {
...
/***/ 5:
/*!***************************************************!*\
  !*** multi ./src/js/page.js ./src/scss/page.scss ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! ./src/js/page.js */"./src/js/page.js");
module.exports = __webpack_require__(/*! ./src/scss/page.scss */"./src/scss/page.scss");
